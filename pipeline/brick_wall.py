...
CONFIG = {
    ...
    # fractions of the hex circumradius - see docs/HEX_TILES.md, which is emphatic
...
def hex_tile(kind="Plain", radius=1.0, source=None):
    ...
    docs/HEX_TILES.md has already settled, differing from the real one in whatever
