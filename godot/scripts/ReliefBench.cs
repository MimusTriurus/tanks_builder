...
/// alone:
///
///     Godot_v4.7.2-stable_mono_win64.exe --path godot res://Relief.tscn
///
...
public sealed partial class ReliefBench : Node2D
{
    ...
    /// its three classes at 0.85 / 1.00 / 1.10, so a tenth apart is what "a
    /// heavier tank" already means on this board. A level has to stay well under
    /// that or a light tank on a rise reads as a medium: at 0.06 it comes out
    /// 0.90 against the medium's 1.00, still clearly the smaller machine, where
    /// 0.10 would put it at 0.935 - a whole class step of lift - and start the
    /// argument.
    ///
