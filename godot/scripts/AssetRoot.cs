...
///
/// So it is derived instead. `res://` is `godot/`, the output is its
...
internal static class AssetRoot
{
    ...
    internal static readonly string Sounds = Repo + "/assets/Sounds";
    ...
    internal static readonly string Terrains = Repo + "/assets/Images/Terrains";
    ...
    internal static readonly string Props = Repo + "/assets/Images/Environment";
    ...
    /// </summary>
    internal static readonly string Water = Repo + "/assets/Images/Water";

    /// <summary>
    /// What the rules put on a cell and the player has to see: the mine, for now -
    /// <see cref="MineArt"/>.
    ///
    /// <b>Its own folder for the water's reason, and this time it was measured
    /// rather than foreseen.</b> The mine's art arrived as
    /// <c>Terrains/tm_62.png</c>, and <see cref="TerrainSet"/> took it: the bench
    /// reported "terrain 4 kinds (plain, soil_2, soil, <b>tm_62</b>)" and a board
    /// painted "mixed" picks a kind per cell by hash, so hexes would have come up
    /// paved with a mine two metres across. Anything read as ground goes in
    /// Terrains; anything that stands on ground does not.
    /// </summary>
    internal static readonly string Markers = Repo + "/assets/Images/Markers";
