...
public class McpBench
{
	...
	[Description("Report every tank on the board: index, tag (LTP/MTP/HTP/TDP/HMP), which one is "
	...
	[Description("Take control of one of the tanks by index, as the number keys 1-5 do. "
		+ "The others stay on the board in whatever state they were left.")]
	...
	[Description("Put the board back as R does: tanks repaired, fires out, shells cleared, "
		+ "orders dropped. The camera is left where it is - see Main.ResetAll.")]
