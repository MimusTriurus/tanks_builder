...
public sealed partial class ProcFume : Node2D
{
    ...
    public override void _Draw()
    {
        ...
        // flame is laid out along Dir in bore radii, so a laid gun drawn with
        // a level bore points its flame where the tube is not. See
        // AtlasSet.BoreAt and TankSprite.BarrelRung.
        AtlasSet.Port bore = atlas.BoreAt(Tank.BarrelRung);
