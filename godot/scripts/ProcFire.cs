...
public sealed partial class ProcFire : Node2D
{
    ...
    /// <summary>Whether a root opens with the flame built rather than read. True
    /// for <see cref="ProcSmoke.OnByDefault"/>'s reason: the built track is the
    /// game's, and the rendered flame stays as the other side of the A/B.</summary>
