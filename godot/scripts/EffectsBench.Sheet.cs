...
public sealed partial class EffectsBench
{
    ...
    private static readonly Puff[] Puffs =
    {
        ...
        new("sheet.look", "sheet.look.blend", true, "frame_blend",
            "how much one cell crosses into the next", 0.0, 1.0, 0.02),
        new("sheet.look", "sheet.look.ease", true, "sheet_ease",
            "how fast the sheet spends its early cells", 0.30, 1.60, 0.02),
        ...
        // --- the air it heats -----------------------------------------------
        new("sheet.haze", "sheet.haze.swell", true, "swell",
            "how much wider the haze is than the smoke", 1.0, 2.60, 0.05),
        new("sheet.haze", "sheet.haze.warp", true, "haze_warp",
            "how far it pulls the board", 0.0, 0.05, 0.001),
        new("sheet.haze", "sheet.haze.blur", true, "haze_blur",
            "how much it softens what is behind", 0.0, 4.0, 0.1),
        new("sheet.haze", "sheet.haze.ink", true, "haze_ink",
            "how much of the bent board is drawn", 0.0, 1.0, 0.02),
        new("sheet.haze", "sheet.haze.out", true, "haze_out",
            "haze out by", 0.02, 1.20, 0.02),
