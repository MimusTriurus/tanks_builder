...
public sealed partial class BoardMap
{
    ...
    /// <summary>Where the five park, in the south. Abreast on one row and at
    ...
    /// would go; nothing here has two sides yet.
    ///
    /// Every other column, eastward from 8, and the row's whole dry span is
    /// 3..16 - so 16 is the last home this line can hold and a sixth class would
    /// have to start the row further west rather than squeeze in.</summary>
    private static readonly Parking[] AbbeyHomes =
    {
        new Vector2I(8, 16), new Vector2I(10, 16), new Vector2I(12, 16),
        new Vector2I(14, 16), new Vector2I(16, 16),
    };
